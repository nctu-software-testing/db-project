...
INSERT INTO `category` (`id`, `product_type`) VALUES
(1, '食品'),
(2, '家具');
...
(1, 13, '2132', '321'),
(2, 13, '新北市123區456街789號', '12345'),
(3, 13, '新北市123區456街789號', '123455'),
(4, 13, '3213', '321'),
(5, 13, '12312', '207'),
(6, 13, '1', '200'),
(7, 13, '1', '200'),
...
INSERT INTO `on_product` (`id`, `product_name`, `product_information`, `expiration_date`, `end_date`, `price`, `state`, `category_id`) VALUES
(1, '雞蛋', '就只是一顆雞蛋。', '2017-11-15 00:00:00', '2017-11-22 00:00:00', 10, 0, 1),
(2, '香蕉', '就是一根香蕉', '2017-11-16 00:00:00', '2017-11-17 00:00:00', 100, 0, 1);
...
CREATE TABLE `order` (
  ...
  `state` varchar(6) COLLATE utf8mb4_unicode_ci NOT NULL,
...
(1, 14, 'images/ioWYYqz2fjphHZEKGFdYBVkAKDacdXwuLG67ruG4.png', 'images/jkgV8b95wY9WLwojRxfxOJPsiocJJJeAVoT6xhMU.png', '2017-11-15 08:11:06', '驗證失敗', '2017-11-15 08:11:06', '123');
